...
public class UserLayerChildLayerTreeCell extends CustomTreeCell{
	...
	public UserLayerChildLayerTreeCell(String item) {
	...
	public void fillContainer() {
        ...
        String[] featuresNames = {"Add", "Delete", "Clear", "Rename"};
